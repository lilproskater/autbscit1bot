...
SUPER_ADMIN_ID = 'SUPER_ADMIN_ID_HERE'  # Super admin can use "/set_group", "/set_subjects" and "/set_admins" commands
GROUP_ID = 'GROUP_ID_HERE'  # Group ID where bot sends messages to (using "/send_group", "/reply_group" etc. commands)
